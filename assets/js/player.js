...
const secretColorsResult = secretColorList(colorList);
console.log(secretColorsResult, "estos son los colores ganadores....");
console.log(userColorList, "estos son los colores jugados....");
...
const result = calculateMatches(secretColorsResult, userColorList);
console.log(result);
